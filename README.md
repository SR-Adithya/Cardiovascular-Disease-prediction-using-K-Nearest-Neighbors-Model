...
-**\(FN (False negative )\)**= incorrect prediction of negative classes
	...
	Formula used: $$ \text{F1 score} = \frac{2 × (Precision × Recall)}{(Precision + Recall)} $$
	Reduces false positives and false negatives
Evaluated Metric Values from the model: 10, 25,94,549
	Confusion matrix: 
	| **Predicted \\ Actual** | **Positive (1)** | **Negative (0)** |
|-------------------------|------------------|------------------|
| **Positive (1)**        | 10               | 25               |
